...
#################################################
### ASSESS PRE-EMREGENCE HERRICIDE RESISTANCE ###
#################################################
# DIR=/data-weedomic-2/weedomics-1.c.3
# DIR_SRC=${DIR}/SeedMatic/src
# EXTENSION_NAME='jpg'
# time \
# for DIR_INPUT in $(ls $DIR | grep "^Batch")
# do
#     blur_threshold='2000'
#     plate_shape='round'
...
#             --debug ${debug}
# done
# OUTPUT="1.c.3.-BoxerGold-assay_output.csv"
# echo "BATCH,DAY,PLATE-REP,NSHOOTS,NSEEDLINGS,GERM,ASHOOTS,AROOTS" > $OUTPUT
# for DIR_INPUT in $(ls $DIR | grep "^Batch")
# do
#     for f in $(ls ${DIR_INPUT}/OUTPUT/*.csv)
#     do
#         batch=$(echo $DIR_INPUT | cut -d'-' -f1)
#         day=$(echo $DIR_INPUT | cut -d'-' -f2)
#         echo ${batch},${day},$(cat $f) >> $OUTPUT
#     done
# done
